...
/// </summary>
public class PostToolUseCommand : AsyncCommand<HooksSettings>
{
    public override async Task<int> ExecuteAsync(CommandContext context, HooksSettings settings)
    {
        AnsiConsole.MarkupLine("[cyan]PKS Hooks: PostToolUse Event Triggered[/]");
        ...
        // Success exit code
        AnsiConsole.MarkupLine("\n[green]✓ PostToolUse hook completed successfully[/]");
        return 0;
    }
}