...
/// <summary>
/// Command for handling SubagentStop hook events from Claude Code
/// </summary>
public class SubagentStopCommand : AsyncCommand<HooksSettings>
{
    public override async Task<int> ExecuteAsync(CommandContext context, HooksSettings settings)
    {
        AnsiConsole.MarkupLine("[cyan]PKS Hooks: SubagentStop Event Triggered[/]");
        ...
        // Success exit code
        AnsiConsole.MarkupLine("\n[green]✓ SubagentStop hook completed successfully[/]");
        return 0;
    }
}