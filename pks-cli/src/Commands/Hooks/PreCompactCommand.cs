...
/// <summary>
/// Command for handling PreCompact hook events from Claude Code
/// </summary>
public class PreCompactCommand : AsyncCommand<HooksSettings>
{
    public override async Task<int> ExecuteAsync(CommandContext context, HooksSettings settings)
    {
        AnsiConsole.MarkupLine("[cyan]PKS Hooks: PreCompact Event Triggered[/]");
        ...
        // Success exit code
        AnsiConsole.MarkupLine("\n[green]✓ PreCompact hook completed successfully[/]");
        return 0;
    }
}